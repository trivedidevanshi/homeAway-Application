    ...
    submitLogin = (e) => {
        ...
        if(result===true){
            ...
            axios.post('http://localhost:3001/signUp',data)
                ...
                .catch(err=>{
                    console.log("noo");
                    alert("Traveler not created. Email already exists");
                });
        }
    }
                ...
                <div className="container-fluid travelerLoginBackground">
                    <div className="travelerLoginFormBackground">
                        <div className="travelerLoginClass">
                            ...
                            <h4>Already have an account? <a href="http://localhost:3000/travelerLogin">Login In</a></h4>
