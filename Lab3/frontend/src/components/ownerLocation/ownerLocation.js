...
class ownerLocation extends Component {
    ...
    handleGotoDetails=(e)=>{
        ...
        console.log("This one---------",localStorage.getItem("headline"));
        if(localStorage.getItem("headline")=="" || localStorage.getItem("propDescription")=="" 
        || localStorage.getItem("propType")==""|| localStorage.getItem("bedroom")==""
        || localStorage.getItem("accomodates")=="" || localStorage.getItem("bathrooms")==""){
            this.setState({
                gotoDetailsFlag:false
            })
