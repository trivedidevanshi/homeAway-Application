...
import { addTravelerMutation } from '../../mutation/mutations';
//import './signUp.css';
...
class signUp extends Component {
    ...
    submitLogin = (e) => {
        ...
        if(result===true){
            this.props.addTravelerMutation({
                variables: {
                ...
                <div className="container-fluid travelerLoginBackground">
                    <div className="travelerLoginFormBackground">
                        <div className="travelerLoginClass">
                            <h1 className="SignupLoginText">Traveler Sign Up for HomeAway</h1>
                            <h4>Already have an account? <a href="/travelerLogin">Login In</a></h4>
                        ...
                        <div className="signUpLoginBack">
                            ...
                            <form >
                                ...
                                <button onClick = {this.submitLogin} type="submit" className="signUpButton">Sign Me Up</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
export default compose(
    graphql(addTravelerMutation, {name:"addTravelerMutation"})
)(signUp);