...
import { mainPageMutation } from '../../mutation/mutations';
  ...
  onSearch = (e) => {
    ...
    if (localStorage.getItem("travelerCookie")) {
      ...
      if (result === true) {
        ...
        this.props.mainPageMutation({
          variables: { 
            city: this.state.destination,
            availablestart: this.state.arrivalDate,
            availableend: this.state.departDate,
...
export default compose(
  graphql(mainPageMutation, {name:"mainPageMutation"})
) (mainPage);
