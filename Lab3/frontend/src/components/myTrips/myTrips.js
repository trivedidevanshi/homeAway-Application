...
import { myTripQuery } from '../../queries/queries'
...
class myTrips extends Component {
    ...
    componentDidMount() {
        ...
        var token = localStorage.getItem('token');
        var tokenemail = localStorage.getItem('tokenemail');
        console.log("The email is ", tokenemail );
        this.props.client.query({
            ...
            console.log("The response is : ", res.data.myTripQuery.travelerbooking[1]);

            if (res.data.myTripQuery.travelerbooking.length > 0) {

                let i = 0;
                for (i = 0; i < res.data.myTripQuery.travelerbooking.length; i++) {
                    this.setState({
                        rdata: this.state.rdata.concat([{
                            propName: res.data.myTripQuery.travelerbooking[i].propname,
                            propDescription: res.data.myTripQuery.travelerbooking[i].propdescription,
                            address: res.data.myTripQuery.travelerbooking[i].address,
                            city: res.data.myTripQuery.travelerbooking[i].city,
                            state: res.data.myTripQuery.travelerbooking[i].state,
                            country: res.data.myTripQuery.travelerbooking[i].country,
                            zipcode: res.data.myTripQuery.travelerbooking[i].zipcode,
                            propPhotos: res.data.myTripQuery.travelerbooking[i].propPhotos,
                            bedrooms: res.data.myTripQuery.travelerbooking[i].bedroom,
                            propType: res.data.myTripQuery.travelerbooking[i].proptype,
                            bathroom: res.data.myTripQuery.travelerbooking[i].bathrooms,
                            accomodates: res.data.myTripQuery.travelerbooking[i].accomodates,
                            pricePerNight: res.data.myTripQuery.travelerbooking[i].pricepernight,
                            bookdateStart: res.data.myTripQuery.travelerbooking[i].bookdatestart,
                            bookdateEnd: res.data.myTripQuery.travelerbooking[i].bookdateend
                        }])
                    });
                }
                this.setState({
